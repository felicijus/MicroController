...
String StateOutD6 = "off";
String StateOutD8 = "off";

// Assign output variables to GPIO pins
const int OutputD6 = D6;
const int OutputD8 = D8;
            ...
            if (client.available()) {             // if there's bytes to read from the client,
                ...
                if (c == '\n') {                    // if the byte is a newline character
                    ...
                    if (currentLine.length() == 0) {
                        ...
                        // Web Page Heading
                        client.println("<body><h1>ESP8266 Universal IR Web Server</h1>");

                        // Display current state, and ON/OFF buttons for GPIO D6  
                        client.println("<p>GPIO D6 - State " + StateOutD6 + "</p>");
                        // If the StateOutD6 is off, it displays the ON button       
                        if (StateOutD6=="off") {
                        ...
                        client.println("<p>GPIO D8 - State " + StateOutD8 + "</p>");
                        // If the StateOutD8 is off, it displays the ON button       
                        if (StateOutD8=="off") {
                        ...
                        client.println("<p>Currently DEV Phase</p>");
